...
namespace CallCentreFollowUps.Models
{
    ...
    public partial class MTNIssuesPortalEntities : DbContext
    {
        public MTNIssuesPortalEntities()
            : base("name=MTNIssuesPortalEntities")
        {
        }
        ...
        public virtual DbSet<tblEFSUser> tblEFSUsers { get; set; }
        public virtual DbSet<lutEfsCountry> lutEfsCountries { get; set; }
        ...
        public virtual int uspCreateNewUser(string firstName, string lastName, string password, string roleName, string emailAddress, Nullable<int> countryID, ObjectParameter userID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspCreateNewUser", firstNameParameter, lastNameParameter, passwordParameter, roleNameParameter, emailAddressParameter, countryIDParameter, userID);
        }
    }
}
