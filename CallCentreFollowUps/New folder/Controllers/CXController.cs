    ...
    public class CxController : Controller
    {
        ...
        public ActionResult Index()
        {
            var issues = db.Issuess
                ...
                .Where(i => i.Status.Name == "Completed" || i.Status.Name == "Logged" || i.Status.Name == "In Progress" || i.Status.Name == "Pushed to Test" || i.Status.Name == "Rejected" || i.Status.Name == "Assigned")
                .ToList();
        ...
        public ActionResult Assign(int id, int teamId, int newStatusId, string comment)
        {
            ...
            // Email all users in the selected team
            var fromEmail = ConfigurationManager.AppSettings["outgoingsmtpmailusername"];
            var teamMembers = db.aspnet_Users
                .Where(u => u.TeamId == teamId)
                .Join(db.aspnet_Membership, u => u.UserId, m => m.UserId, (u, m) => new { u.UserName, m.Email })
